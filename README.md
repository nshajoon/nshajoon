SVRCD stands for Stochastic Variance-Reduced Coordinate Descent which is a Bayesian Network (BN) structure learning algorithm. SVRCD learns a sparse BN using High-Dimensional Discrete Data. 
